  ...
  return (
    <Column as="section" maxWidth="m" horizontal="center" gap="l">
      ...
      <Media
        ...
        aspectRatio="16 / 9"
        radius="m"
        alt="Engineering Beyond the Interface"
      ...
      <Column as="article" maxWidth="xs" gap="l">
        ...
        <Text onBackground="neutral-weak">
          • Build for People — Technology ultimately exists to serve users,
          customers, and the teams building the product.
          {"\n\n"}
          • Keep Systems Understandable — Complexity should be introduced only
          when it solves a real problem.
          {"\n\n"}
          • Performance Is a Feature — Fast and responsive software creates
          better product experiences.
          {"\n\n"}
          • Consistency Enables Scale — Shared patterns and standards allow
          teams to move faster with confidence.
          {"\n\n"}
          • Automate Repetitive Work — Engineers should spend more time solving
          meaningful problems and less time repeating predictable tasks.
          {"\n\n"}
          • Stay Hands-On — Leadership becomes stronger when technical decisions
          remain grounded in real engineering experience.
          {"\n\n"}
          • Think Long-Term — The best engineering decisions create value beyond
        ...
        <Text onBackground="neutral-weak">
          Frontend engineering gave me a strong foundation in building products.
          Architecture taught me to think about systems. Engineering leadership
          has taught me to think about people, execution, and impact.
        </Text>
